...
MainWindow::MainWindow():
    m_mainWindowLayout(new QVBoxLayout(this)),
...
void MainWindow::InitializeMainWindow() {
    m_mainWindowLayout->addWidget(m_chartWidget, 10, Qt::AlignLeft);
    m_mainWindowLayout->addWidget(m_buttonWidget, 10, Qt::AlignRight);
